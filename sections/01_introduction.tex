...
\begin{align}
    ...
    \label{eq:h3_alt}
\end{align}
The confirmatory analysis examines changes in forecast loss and forecast values for the frozen stage policy. Candidate-model ranking sensitivity is treated as a secondary robustness question rather than as part of the confirmatory H3 archive. The sign of the vintage effect is left to the data rather than imposed ex ante.
