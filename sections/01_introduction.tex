...
\begin{enumerate}[label=\textbf{RQ\arabic*:}, leftmargin=*]
    ...
    \item Do genuine real-time data vintages materially alter measured forecast performance relative to latest-vintage data?
...
H3 & Do genuine historical vintages change forecast evaluation? & Real-time and latest-vintage expected losses are equal. & Loss differential; forecast-value revisions. \\
